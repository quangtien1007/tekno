                ...
                <form action="{{ route('admin.hangsanxuat.update', ['id' => $hangsanxuat->id]) }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        @if(!empty($hangsanxuat->hinhanh))
                            <img class="d-block rounded img-thumbnail" src="{{ env('APP_URL') . '/images/' . $hangsanxuat->hinhanh }}" width="100" />
                    ...
                    <button style="float:right" type="submit" class="btn btn-primary"><i class="fal fa-save"></i> Cập nhật</button>
                </form>
            </div>
        </div>
    </div>
