			...
			<form action="{{ route('admin.sanpham.sua', ['id' => $sanpham->id]) }}" method="post" enctype="multipart/form-data">
				...
				<div class="mb-3">
					...
					@if(!empty($sanpham->hinhanh))
						<img class="d-block rounded img-thumbnail" src="{{ env('APP_URL') . '/storage/app/sanpham/' . $sanpham->hinhanh }}" width="100" />
				...
				<div class="mb-3">
					...
					<textarea class="form-control" id="myeditorinstance" name="motasanpham">{{ $sanpham->motasanpham }}</textarea>
				</div>
